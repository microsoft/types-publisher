...
If you need to update dependenciesWhitelist.txt, please do so at its [new location](https://github.com/microsoft/DefinitelyTyped-tools/blob/master/packages/definitions-parser/dependenciesWhitelist.txt).
