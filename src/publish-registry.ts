...
if (!module.parent) {
	...
	done(getDefinitelyTyped(Options.defaults).then(dt => main(dt, dry, new UncachedNpmInfoClient())));
}

export default async function main(dt: FS, dry: boolean, client: UncachedNpmInfoClient): Promise<void> {
