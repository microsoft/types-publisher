...
if (!module.parent) {
	const dry = !!yargs.argv.dry;
		...
		await main(dt, await AllPackages.read(dt), dry, new UncachedNpmInfoClient());
	});
}

export default async function main(dt: FS, allPackages: AllPackages, dry: boolean, client: UncachedNpmInfoClient): Promise<void> {
