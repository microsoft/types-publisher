...
export declare function createNotNeededPackageJSON({ libraryName, license, unescapedName, fullNpmName, sourceRepoURL, version, }: NotNeededPackage, registry: Registry): string;
export declare function createReadme(typing: TypingsData): string;
