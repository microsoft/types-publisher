...
if (!module.parent) {
    ...
    util_1.done(main(common_1.Options.defaults, dry, new io_1.Fetcher()));
}
function main(options, dry, fetcher) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const registry = JSON.stringify(yield generateRegistry(typings, fetcher, options));
...
function generateRegistry(typings, fetcher, options) {
    return __awaiter(this, void 0, void 0, function* () {
        const entries = {};
        yield util_1.nAtATime(options.fetchParallelism, typings, (typing) => __awaiter(this, void 0, void 0, function* () {
            const info = yield npm_client_1.fetchNpmInfo(typing.fullEscapedNpmName, fetcher);
