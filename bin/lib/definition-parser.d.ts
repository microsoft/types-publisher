...
export declare function getTypingInfo(packageName: string, fs: FS): Promise<TypingsVersionsRaw>;
export declare function parseMajorVersionFromDirectoryName(directoryName: string): number | undefined;
export declare function readFileAndThrowOnBOM(fileName: string, fs: FS): Promise<string>;
